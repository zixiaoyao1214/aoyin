...
get_service_names() -> ['return.Return'].


get_service_def('return.Return') ->
...
get_rpc_names('return.Return') -> ['GetMoney'];
get_rpc_names(_) -> error.


find_rpc_def('return.Return', RpcName) ->
    'find_rpc_def_return.Return'(RpcName);
find_rpc_def(_, _) -> error.


'find_rpc_def_return.Return'('GetMoney') ->
    #{name => 'GetMoney', input => account_plat,
      output => charge, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_return.Return'(_) -> error.
...
fqbin_to_service_name(<<"return.Return">>) -> 'return.Return';
...
service_name_to_fqbin('return.Return') -> <<"return.Return">>;
...
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"return.Return">>, <<"GetMoney">>) ->
    {'return.Return', 'GetMoney'};
...
service_and_rpc_name_to_fqbins('return.Return',
			       'GetMoney') ->
    {<<"return.Return">>, <<"GetMoney">>};
...
fqbin_to_msg_name(<<"return.AccountPlat">>) -> account_plat;
fqbin_to_msg_name(<<"return.Charge">>) -> charge;
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin(account_plat) -> <<"return.AccountPlat">>;
msg_name_to_fqbin(charge) -> <<"return.Charge">>;
...
get_pkg_containment("return") -> return;
get_pkg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_service_containment("return") -> ['return.Return'];
...
get_proto_by_msg_name_as_fqbin(<<"return.AccountPlat">>) -> "return";
get_proto_by_msg_name_as_fqbin(<<"return.Charge">>) -> "return";
get_proto_by_msg_name_as_fqbin(E) ->
    error({gpb_error, {badmsg, E}}).


get_proto_by_service_name_as_fqbin(<<"return.Return">>) -> "return";
...
get_protos_by_pkg_name_as_fqbin(<<"return">>) -> ["return"];
get_protos_by_pkg_name_as_fqbin(E) ->
    error({gpb_error, {badpkg, E}}).


descriptor() ->
    <<10, 228, 1, 10, 19, 114, 101, 116, 117, 114, 110, 47,
      114, 101, 116, 117, 114, 110, 46, 112, 114, 111, 116,
      111, 18, 6, 114, 101, 116, 117, 114, 110, 34, 85, 10,
      11, 65, 99, 99, 111, 117, 110, 116, 80, 108, 97, 116,
      18, 20, 10, 7, 97, 99, 99, 111, 117, 110, 116, 24, 1,
      32, 1, 40, 12, 72, 0, 136, 1, 1, 18, 21, 10, 8, 112,
      108, 97, 116, 102, 111, 114, 109, 24, 2, 32, 1, 40, 12,
      72, 1, 136, 1, 1, 66, 11, 10, 9, 95, 95, 97, 99, 99,
      111, 117, 110, 116, 66, 12, 10, 10, 95, 95, 112, 108,
      97, 116, 102, 111, 114, 109, 34, 39, 10, 6, 67, 104, 97,
      114, 103, 101, 18, 18, 10, 5, 109, 111, 110, 101, 121,
      24, 1, 32, 1, 40, 5, 72, 0, 136, 1, 1, 66, 9, 10, 7, 95,
      95, 109, 111, 110, 101, 121, 50, 61, 10, 6, 82, 101,
      116, 117, 114, 110, 18, 51, 10, 8, 71, 101, 116, 77,
      111, 110, 101, 121, 18, 19, 46, 114, 101, 116, 117, 114,
      110, 46, 65, 99, 99, 111, 117, 110, 116, 80, 108, 97,
      116, 26, 14, 46, 114, 101, 116, 117, 114, 110, 46, 67,
      104, 97, 114, 103, 101, 40, 0, 48, 0, 98, 6, 112, 114,
      111, 116, 111, 51>>.

descriptor("return") ->
    <<10, 19, 114, 101, 116, 117, 114, 110, 47, 114, 101,
      116, 117, 114, 110, 46, 112, 114, 111, 116, 111, 18, 6,
      114, 101, 116, 117, 114, 110, 34, 85, 10, 11, 65, 99,
      99, 111, 117, 110, 116, 80, 108, 97, 116, 18, 20, 10, 7,
      97, 99, 99, 111, 117, 110, 116, 24, 1, 32, 1, 40, 12,
      72, 0, 136, 1, 1, 18, 21, 10, 8, 112, 108, 97, 116, 102,
      111, 114, 109, 24, 2, 32, 1, 40, 12, 72, 1, 136, 1, 1,
      66, 11, 10, 9, 95, 95, 97, 99, 99, 111, 117, 110, 116,
      66, 12, 10, 10, 95, 95, 112, 108, 97, 116, 102, 111,
      114, 109, 34, 39, 10, 6, 67, 104, 97, 114, 103, 101, 18,
      18, 10, 5, 109, 111, 110, 101, 121, 24, 1, 32, 1, 40, 5,
      72, 0, 136, 1, 1, 66, 9, 10, 7, 95, 95, 109, 111, 110,
      101, 121, 50, 61, 10, 6, 82, 101, 116, 117, 114, 110,
      18, 51, 10, 8, 71, 101, 116, 77, 111, 110, 101, 121, 18,
      19, 46, 114, 101, 116, 117, 114, 110, 46, 65, 99, 99,
      111, 117, 110, 116, 80, 108, 97, 116, 26, 14, 46, 114,
      101, 116, 117, 114, 110, 46, 67, 104, 97, 114, 103, 101,
